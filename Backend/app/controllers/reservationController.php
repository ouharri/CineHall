            ...
            if (_isset::post('id')) {
                ...
                try {
                    ...
                    if ($data) {
                        ...
                        $html = <<<HTML
                            <div class="container" style="display: flex !important;max-width: 1350px;margin: 0 auto;overflow: hidden">
                                <div class="item" style=" display: flex!important; width: 100%; height: 346px !important; float: left; padding: 0 10px; background: #fff; overflow: hidden; margin: 10px ">
                                    <div style=" display: flex!important;">
                                        <div style="text-align: center">
                                            ...
                                            <div class="item-right"
                                                 style=" float: left; padding: 79px 50px; z-index: 5 !important; display: flex; align-items: center; margin-right: 20px; width: 25%; position: relative; height: 286px; ">
                                                <div style="text-align: center;">
                                                    <h2 class="num" style="font-size: 60px;text-align: center;color: red;">$data[seat]</h2>
                                                    <p class="day" style=" color: #555; font-size: 15px; margin-bottom: 9px; ">SEAT</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div style="display: flex">
                                            <div class="item-left">
                                                ...
                                                <div style="display: flex;width: 100%;justify-content: space-between">
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                    <button class="tickets" style=" background-color: red; margin-bottom: 10px; ">Tickets
                                                    </button>
                                                </div>
                                                <div class="fix"></div>
                                            </div>
                                            <img src="$data[movieImage]" alt="movie"
                                                 style="margin-left: 53px;width: 200px; z-index: 1;opacity: 40% !important;"/>
                                        </div>
                                    </div>
                                </div>
                            </div> 
