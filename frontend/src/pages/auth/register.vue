<template>
  <div
      class="flex my-12 flex-col justify-center transition rounded-3xl duration-1000 ease-linear border-zinc-200 bg-gradient-to-tr from-gray-50 dark:2xl:border-zinc-700 dark:from-black/10 to-transparent dark:text-gray-200 overflow-x-hidden transition duration-1000 ease-linear overflow-hidden shadow"
  >
